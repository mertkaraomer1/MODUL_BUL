...
namespace MODUL_BUL
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            using (var context = new TContext()) // DbContext sýnýfýnýzý belirtin
            {
                ...
                foreach (DataGridViewRow row in advancedDataGridView1.Rows)
                {
                    ...
                    string projeno = row.Cells["PROJE KODU"].Value?.ToString();
        ...
        {
            string projekod = textBox1.Text.Trim();
        ...
        {
            string projekod = textBox2.Text;
            string resimno = textBox3.Text;
            table.Columns.Clear();
            table.Rows.Clear();
            table.Clear();
            table.Columns.Add("SATIR NO");
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            using (var context = new TContext()) // DbContext sýnýfýnýzý belirtin
            {
                string projeno = textBox2.Text; // Proje numarasýný al
